            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <?php endif; ?>
                  <!-- Form start -->
                  <?= form_open('login/index', ['class' => 'row g-3 needs-validation', 'novalidate' => true]); ?>
                    ...
                    <div class="col-12" style="text-align:center;">
                      <p class="small mb-0">Tidak Punya Akun? <a href="<?= base_url('login/registrasi'); ?>">Registrasi</a></p>
                    </div>
                  <?= form_close(); ?>
                  <!-- Form end -->
